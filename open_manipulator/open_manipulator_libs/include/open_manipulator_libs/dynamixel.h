...
/***************ADD***************/
  uint32_t dxl_id_11_position_p_gain;
  uint32_t dxl_id_11_position_i_gain;
  uint32_t dxl_id_11_position_d_gain;
  uint32_t dxl_id_11_feedforward_1st_gain;
  uint32_t dxl_id_11_feedforward_2nd_gain;
  ...
  uint32_t dxl_id_14_position_p_gain;
  uint32_t dxl_id_14_position_i_gain;
  uint32_t dxl_id_14_position_d_gain;
  uint32_t dxl_id_14_feedforward_1st_gain;
  uint32_t dxl_id_14_feedforward_2nd_gain;
